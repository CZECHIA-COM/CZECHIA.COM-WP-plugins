...
Tyto pluginy **nejsou open-source** a **nejsou určeny k obecnému použití**.
...
- nahlášení chyb (Issues)
- návrhy vylepšení
- pull requesty **do tohoto repozitáře**
...
- opravit chybu
- navrhnout zlepšení
- diskutovat úpravu funkcionality

Použijte prosím:
- **GitHub Issues**
- **Pull Request** (bez forkování pro produkční použití)

---

## 📄 Licence

Tento projekt je licencován pod **Custom Proprietary License** – viz soubor [LICENSE](LICENSE).
